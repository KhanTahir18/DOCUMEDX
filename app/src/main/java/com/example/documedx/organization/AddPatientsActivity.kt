...
class AddPatientsActivity: AppCompatActivity() {
    private lateinit var binding: ActivityAddPatientInOrganizationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddPatientInOrganizationBinding.inflate(layoutInflater)
        setContentView(binding.root)

        licence = intent.getStringExtra("licence")
        Toast.makeText(this, "Licence: $licence", Toast.LENGTH_SHORT).show()
